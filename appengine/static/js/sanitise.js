...
/**
 * @fileoverview
 * An HTML sanitiser that can satisfy a variety of security policies.
 *
 * <p>
 * The HTML sanitiser is built around a SAX parser and HTML element and
 * attributes schemas.
 *
 * @author mikesamuel@gmail.com
 * @requires html4
 * @provides html, html_sanitise
 */
...
var html = (function () {
  ...
  // TODO(mikesamuel): validate sanitiser regexs against the HTML5 grammar at
 ...
 * @param {Function} sanitiseAttributes
 *     maps from (tagName, attribs[]) to null or a sanitised attribute array.
 *     The attribs array can be arbitrarily modified, but the same array
 *     instance is reused, so should not be held.
 * @return {Function} from html to sanitised html
 */
html.makeHtmlSanitiser = function (sanitiseAttributes) {
  var stack;
  var ignoring;
  return html.makeSaxParser({
        ...
        startTag: function (tagName, attribs, out) {
          ...
          attribs = sanitiseAttributes(tagName, attribs);
          // TODO(mikesamuel): relying on sanitiseAttributes not to
 ...
 * @param {string} htmlText to sanitise
 ...
 * @return {string} html
 */
function html_sanitise(htmlText, opt_urlPolicy, opt_nmTokenPolicy) {
  var out = [];
  html.makeHtmlSanitiser(
      function sanitiseAttribs(tagName, attribs) {
