...
// ondocumentready funktion

$(function () {

  $('.more-link').fancybox({hideOnContentClick: false, frameWidth: 800, frameHeight: 400, imageScale: false});
  ...
  if (share_elem_1) {
    var share_button_1 = SHARETHIS.addEntry({url: 'http://espra.com'}, {button: false});
    share_button_1.attachButton(share_elem_1);
  }

  var share_elem_2 = document.getElementById('sharethis-2');
  if (share_elem_2) {
    var share_button_2 = SHARETHIS.addEntry({url: 'http://espra.com'}, {button: false});
...
var google_translate_page = function (lang_options) {
  var google_translate_url = 'http://translate.google.com/translate?u=http%3A%2F%2Fespra.com';
