...
func TestDecimalDiv(t *testing.T) {
	...
	tests := [][]string{
		...
		[]string{"0.5", "0.2", "2.5"},
		[]string{"0.5", "-0.5", "-1"},
		[]string{"4", "-3", "-1.33333333333333333333"},
		[]string{"0.0000000000000000000000001", "20000000000",
			"0"},
		[]string{"0.00000000000000000001", "1",
			"0.00000000000000000001"},
		[]string{"0.0000000000000000000000001", "1",
			"0"},
		[]string{"4", "-0.0000000000000000000000001",
			"-40000000000000000000000000"},
		[]string{"4", "-0.000000000000000000001",
			"-4000000000000000000000"},
		[]string{"4.51", "-3.21", "-1.40498442367601246105"},
		[]string{"-3", "-4", "0.75"},
		[]string{"-0.1", "0.2", "-0.5"},
		[]string{"-0.1", "-0.2", "0.5"},
	}
...
func TestDecimalComponents(t *testing.T) {
	...
	tests := [][]string{
		[]string{"0.1", "0", "11000000000000000000"},
		[]string{"-0.1", "-0", "11000000000000000000"},
		[]string{"-1.2", "-1", "12000000000000000000"},
	}
